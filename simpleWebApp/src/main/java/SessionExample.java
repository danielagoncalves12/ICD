...
public class SessionExample extends HttpServlet {
    ...
    private static final ResourceBundle RB = ResourceBundle.getBundle("LocalStrings",Locale.FRENCH);
        ...
        throws IOException, ServletException
    {
        ...
        out.println("\" >Direct URL encoded (SessionExample?dataname=foo&datavalue=bar)</a>");
